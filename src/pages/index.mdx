...
<Box top={{ xs: 144, lg: 190 }}>
  <CallToActionSection
    title="Scalable, Reliable, and Secure Decentralized Communication"
    columns={1}
    border={false}
    align="center"
    description={<>
      Waku delivers a unified technology stack addressing the unique challenges of decentralized peer-to-peer communication, offering turnkey reliability, scalability, and censorship resistance for your applications. Built on libp2p, Waku enhances its capabilities to ensure optimal performance in diverse network conditions.<br /><br />
      Learn more about <a href="https://blog.waku.org/explanation-series-light-protocols-and-edge-nodes/" target="_blank">Light protocols and edge nodes</a>, <a href="https://blog.waku.org/explanation-series-rln-relay/" target="_blank">RLN Relay</a>, and Waku's objective of creating <a href="https://blog.waku.org/explanation-series-a-unified-stack-for-scalable-and-reliable-p2p-communication/" target="_blank">A unified stack for scalable and reliable P2P communication</a>.
    </>}
    label="Waku Blog"
...
<Box top={{ xs: 144, lg: 190 }}>
  <Roadmap
    ...
    timeline={[
      ...
      {
        period: [2024, "H2"],
        description: "RLNv2: Flexible rate limit, onchain Merkle tree for faster initialisation, definition of membership economics. Tunable peer-to-peer reliability protocols; Scalable Data Sync protocol: end-to-end reliability protocol; Hardening of Status chat protocols."
      },
      {
        period: [2025, "+"],
        description: "Simplified Waku Message API across all implementations. Incentivization, RLN in mainnet and browser, store decentralization. Status chat protocols scalability and optimization."
      },
    ]}
  >
  </Roadmap>
