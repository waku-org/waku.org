...
<Box top={{ xs: 8 }}>
  <EventBanner src="/events/monerokon.png" />
  <EventHeader 
  ...
  <Grid xs={{ cols: 2, gap: '1rem' }} md={{ cols: 2 }}>
    <Grid.Item xs={1}>
      ...
      <Grid.Item xs={1}>
        <EventInfo 
          label="Location"
          content={'Paralelní Polis, Prague,\nCzech Republic'}
        /> 
      </Grid.Item>
    </Grid>
  </Box>
    ...
    <Grid xs={{ cols: 2, gap: '1rem' }} md={{ cols: 2 }}>
      <Grid.Item xs={1}>
        <EventInfo 
          ...
          content={
            <>
            Make sure to attend our speaking engagements:
            <br/>
            <br/>
            1. <b>Workshop</b> by our protocol engineer Sasha on strategies for developing permissionless p2p networks that prioritize privacy, touching on rate limiting solutions to ensure network efficiency & security
            <br/>
            <br/>
            2. <b>Discussion panel</b> moderated by our eco dev team lead Marina on Unraveling the Cypherpunk Legacy: Privacy, Security, and Freedom 
            Have any questions about the event our tech?
            </>
          }
        /> 
        </Grid.Item>
        ...
        <EventInfo 
          ...
          content={
            <>
            Don't forget to checkout the Waku booth at Monerokon!
            <br/>
            <br/>
            Waku core contributors will be available for chitchats and we will also have some exclusive Waku swag up for grabs!
            </>
          }
        /> 
        </Grid.Item>
